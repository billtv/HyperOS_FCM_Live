...
/**
 * A collection of methods for performing low-level, unsafe operations. Although the class and all
 * methods are public, use of this class is limited because only trusted code can obtain instances
 * of it.
 *
 * @author John R. Rose
 * @see #getUnsafe
...
public final class Unsafe {
    ...
    /**
     * Gets the raw byte offset from the start of an object's memory to the memory used to store the
     * indicated instance field.
     *
     * @param field non-{@code null}; the field in question, which must be an instance field
    ...
    /**
     * Gets the offset from the start of an array object's memory to the memory used to store its
     * initial (zeroeth) element.
     *
    ...
    /**
     * Performs a compare-and-set operation on an {@code int} field within the given object.
     *
     ...
     * @return {@code true} if the new value was in fact stored, and {@code false} if not
     */
    public native boolean compareAndSwapInt(Object obj, long offset, int expectedValue, int newValue);

    /**
     * Performs a compare-and-set operation on a {@code long} field within the given object.
     *
     * @param obj           non-{@code null}; object containing the field
     * @param offset        offset to the field within {@code obj}
     * @param expectedValue expected value of the field
    ...
    /**
     * Performs a compare-and-set operation on an {@code obj} field (that is, a reference field)
    ...
    public native boolean compareAndSwapObject(
            Object obj, long offset, Object expectedValue, Object newValue);

    /**
     * Gets an {@code int} field from the given object, using {@code volatile} semantics.
     *
     * @param obj    non-{@code null}; object containing the field
     * @param offset offset to the field within {@code obj}
    ...
    /**
     * Stores an {@code int} field into the given object, using {@code volatile} semantics.
     *
     * @param obj      non-{@code null}; object containing the field
     * @param offset   offset to the field within {@code obj}
    ...
    /**
     * Gets a {@code long} field from the given object, using {@code volatile} semantics.
     *
     * @param obj    non-{@code null}; object containing the field
     * @param offset offset to the field within {@code obj}
     * @return the retrieved value
    ...
    /**
     * Stores a {@code long} field into the given object, using {@code volatile} semantics.
     *
     * @param obj      non-{@code null}; object containing the field
     * @param offset   offset to the field within {@code obj}
     * @param newValue the value to store
    ...
    /**
     * Gets an {@code obj} field from the given object, using {@code volatile} semantics.
     *
     * @param obj    non-{@code null}; object containing the field
     * @param offset offset to the field within {@code obj}
     * @return the retrieved value
    ...
    /**
     * Stores an {@code obj} field into the given object, using {@code volatile} semantics.
     *
     * @param obj      non-{@code null}; object containing the field
     * @param offset   offset to the field within {@code obj}
     * @param newValue the value to store
    ...
    /**
     * Parks the calling thread for the specified amount of time, unless the "permit" for the thread
     * is already available (due to a previous call to {@link #unpark}. This method may also return
     ...
     *
     * @param absolute whether the given time value is absolute milliseconds-since-the-epoch ({@code
     *                 true}) or relative nanoseconds-from-now ({@code false})
    ...
    /**
     * Allocates an instance of the given class without running the constructor. The class' <clinit>
     * will be run, if necessary.
     */
    public native <T> T allocateInstance(Class<T> c);
     ...
     * given object {@code o} at the given {@code offset}.
     *
     ...
     * the given object {@code o} at the given {@code offset}.
     *
     * @param o        object/array to update the field/element in
     * @param offset   field/element offset
     ...
     * fence; a "LoadLoad plus LoadStore barrier".
     *
     * <p>Corresponds to C11 atomic_thread_fence(memory_order_acquire) (an "acquire fence").
     *
     * <p>A pure LoadLoad fence is not provided, since the addition of LoadStore is almost always
     * desired, and most current hardware instructions that provide a LoadLoad barrier also provide a
     * LoadStore barrier for free.
     *
     * @since 1.8
     */
     ...
     * fence; a "StoreStore plus LoadStore barrier".
     *
     * <p>Corresponds to C11 atomic_thread_fence(memory_order_release) (a "release fence").
     *
     * <p>A pure StoreStore fence is not provided, since the addition of LoadStore is almost always
     * desired, and most current hardware instructions that provide a StoreStore barrier also provide
     ...
     * after the fence. Implies the effects of both loadFence() and storeFence(), and in addition, the
     * effect of a StoreLoad barrier.
     *
     * <p>Corresponds to C11 atomic_thread_fence(memory_order_seq_cst).
     *
     * @since 1.8
     */
